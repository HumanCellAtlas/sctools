...
def aggregate_picard_metrics_by_row(file_names, output_name):
    """
    pipeline output picard QC metrics at single cell/sample level.
...
def parse_hisat2_log(file_names, output_name):
    """
    to parse the hisat2 log file, which include alignment summary
...
def parse_rsem_cnt(file_names, output_name):
    """
    to parse the rsem cnt file, which include alignment summary
