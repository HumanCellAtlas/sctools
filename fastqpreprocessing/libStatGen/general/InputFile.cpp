                         ...
                         InputFile::ifileCompression compressionMode)
{
    ...
    else
    {
        ...
        else
        {
            ...
            if (!file.isOpen())
            {
                printf("InputFile.cpp: 198 file could not be opened\n");
            ...
            else
            {
                ...
                if (isGzip)
                {
                    //printf("KMK InputFile.cpp: 233 isGzip according header\n");
                    // This file is a gzip file.
                    // Check to see if it is BGZF Compression.
                    if (gzipHeader.isBgzfFile())
                    {
                        //printf("KMK InputFile.cpp: 239 is a Bgz\n");
                        ...
                        if(myAttemptRecovery) {
                            ...
                            //printf("KMK InputFile.cpp: 247 is a use samtools Bgz\n");
                    ...
                    else
                    {
                        ...
                        //printf("KMK InputFile.cpp: 239 is a NOT Bgz\n");
